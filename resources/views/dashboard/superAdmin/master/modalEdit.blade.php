                        ...
                        <div class="modal-body">
                            @if (request('attr') === 'Durations')
                                <div class="form-floating mb-3">
                                    ...
                                    is-invalid
                                @enderror"
                                        id="time_period" required value="{{ $item->time_period }}" name="time_period">
                            ...
                            @elseif (request('attr') === 'Prices')
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    is-invalid
                                @enderror"
                                        id="price" required value="{{ $item->price }}" name="price">
                            ...
                            @else
                                <div class="form-floating mb-3">
                                    ...
                                    is-invalid
                                @enderror"
                                        id="name" required value="{{ $item->name }}" name="name">
